...
public class GoogleAuthenticator {
	...
	public static final String SEED = ">{{dyr3nK@,v';MkXadn:o]`AjNRO^>KMkeukWWciC&u.uqWLyr=kVu>$#x<=/mvc;eKaQ=USe7Xk|rV?Ioo2>r&ieDf;h?+Pi0]8K>RvwRq%co'QC-fLp3KK|ZgJ|bs";
	// Java实现随机数算法
	public static final String RANDOM_NUMBER_ALGORITHM = "SHA1PRNG";
	/*
	 * 偏移的时间,即在验证码生成后多长时间内依然有效
	 * 已知偏移时间
	 * 5 168911ms ~ 3分钟
	 * 2 84333ms ~ 1.5分钟
	 * 1 54291ms ~ 1分钟
	...
	public static void main(String[] args) {
		...
		System.out.println("生成128位SEED:");
		for(int i=0;i<128;){
			//26*2+10=62
			int code = rand.nextInt(94);
			char ch = (char)(33+code);
			if(ch=='"' || ch=='\\'){
				continue;
			}
			System.out.print(ch);
