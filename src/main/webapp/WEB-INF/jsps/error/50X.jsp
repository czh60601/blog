  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="${rootUrl}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">50X Error Page</span>
    </a>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper" style="min-height: 892px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>50X Error Page</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">50X Error Page</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="error-page">
        <h2 class="headline text-warning"> 50X</h2>

        <div class="error-content">
          <h3><i class="fa fa-warning text-warning"></i> 遇到未知错误,请刷新页面重试！</h3>
          <p>
                                    遇到未知错误,请刷新页面重试！<br>
